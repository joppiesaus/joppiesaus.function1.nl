 ...
 * NOW WITH MODIFIED TEXT, WINDOWS XP ERROR SOUND(michealsoft pls dont sew me), WEIRD CURSOR, THAT IS NOT ORIGINALLY TIM HOLMAN'S HE'S A NICE DUDE
 */
...
(function bsod() {
    ...
    function addLog() {
        ...
        document.body.style.cursor = ["pointer","wait","not-allowed","wait"][errorRotation];
    }
    ...
    function showBSOD() {
        ...
        sound.src = "dl/error.mp3";
        sound.id = "errorsound";
        var autoplayAttrib = document.createAttribute("autoplay");
        sound.setAttributeNode(autoplayAttrib);
        body.appendChild(sound);

        var playErrorSound = function() {
            var soundEl = document.getElementById("errorsound");
        ...
        bsodContainer.onclick = playErrorSound;
